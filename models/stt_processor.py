...
import os
import tempfile
# BARIS INI TELAH DIHAPUS (MoviePy): from moviepy.editor import VideoFileClip 
...
def render_processing_page():
    ...
    if st.session_state.results is None:
        ...
        try:
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                for i in range(1, TOTAL_QUESTIONS + 1):
                    ...
                    if q_id in st.session_state.answers and q_key and q_text:
                        ...
                        # Convert Video to WAV (Menggunakan pydub dari stt_processor)
            ...
            st.warning("Ini mungkin disebabkan oleh keterbatasan memori (OOM) Streamlit Cloud atau kegagalan instalasi. Mohon cek file konfigurasi Anda.")
            progress_bar.empty()
